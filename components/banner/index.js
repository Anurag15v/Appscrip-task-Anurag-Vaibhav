...
function index() {
  ...
  return (
    ...
    <div className={styles['banner-container']}>
      ...
      {windowWidth > 768 && <Image alt="banner" priority={false} className={styles['banner']} src={laptopBanner} />}
      {windowWidth <= 768 && <Image alt="banner" priority={false} className={styles['banner']} src={mobileBanner} />}
    </div>
  )
}
